...
const BookList = ({ selectedCategories, setSelectedCategories }: BookListProps) => {
    ...
    <div className="container d-flex flex-column align-items-center mt-4">
      ...
      {showToast && (
        <div className="toast show position-fixed bottom-0 end-0 m-4" style={{ zIndex: 1050 }}>
          ...
          <div className="toast-body">The book has been added to your cart!</div>
        </div>
      )}
            ...
            <div className="col" key={book.bookId}>
              <div className="card h-100">
                ...
                <div className="card-footer text-center">
                  ...
                  <button className="btn btn-secondary" onClick={() => handleEditBook(book.bookId)}>Edit</button>
